...
where :math:`\mathsf{GroupHash^{\mathbb{P}}}` is the Group Hash into the group of points on the Pallas curve defined in the protocol spec [#protocol-concretegrouphashpallasandvesta]_
