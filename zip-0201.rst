...
On mainnet, a pre-Overwinter node is defined to be a node for which the highest supported protocol version is <= 170003 (since nodes running protocol version 170003 do not have a mainnet activation height set).

These constants allow pre-Overwinter nodes that support protocol version 170002 and 170003, and Overwinter nodes (which support both protocol versions 170002, 170003 and 170004 before Overwinter activation) to remain connected until the activation.
