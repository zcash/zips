...
The ZSA note plaintext also includes the Asset identifier in addition to the components in the Orchard note plaintext.
It consists of 
...
The Orchard Protocol uses a Homomorphic Pedersen Commitment [#protocol-concretevaluecommit]_ to perform the value commitment, which is instantiated as
