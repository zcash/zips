...
.. [#protocol-transactions] `Zcash Protocol Specification, Version 2025.6.1 [NU6.1]. Section 3.4: Transactions and Treestates <protocol/protocol.pdf#transactions>`_
