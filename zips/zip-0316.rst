...
* Revision 1: This version adds support for `MUST-understand Typecodes`_
  ...
  that a UVK must contain at least one shielded Item.
...
As of `Revision 1`_, Transparent P2PKH IVK Items MUST NOT be included
in the derived Unified Address. (Prior to `Revision 1`_, the diversifier
