...
* Revision 2: This version adds support for `MUST-understand Typecodes`_
...
A Revision 0 UA is distinguished from a Revision 2 UA/UVK by its
...
* “``ur``”, if this is a UVK from `Revision 2`_ onward.
...
`Revision 2`_ Unified Address encoded with the ``zu`` prefix. Any Item
