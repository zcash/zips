...
address types permit each Typecode. Producers MUST NOT include Items with
Typecodes not permitted for the address type being produced, and Consumers MUST
reject addresses that contain such Items.
...
::
  ...
  | 0x03              | Orchard                              | ✅ | ✅     | ✅     |
  +-------------------+--------------------------------------+----+--------+--------+
  | 0x04..0xC0        | Unassigned                           | ✅ | ❌     | ✅     |
  +-------------------+--------------------------------------+----+--------+--------+
  | 0xC0..0xE0        | Non-MUST-understand Metadata         | ✅ | ❌     | ✅     |
  +-------------------+--------------------------------------+----+--------+--------+
  | 0xE0              | Address Expiry Height                | ❌ | ✅     | ✅     |
  +-------------------+--------------------------------------+----+--------+--------+
  | 0xE1              | Address Expiry Time                  | ❌ | ✅     | ✅     |
  +-------------------+--------------------------------------+----+--------+--------+
  | 0xE2..0xFD        | Unassigned MUST-understand Metadata  | ❌ | ❌     | ✅     |
  +-------------------+--------------------------------------+----+--------+--------+
  | 0xFD..0xFFFA      | Unassigned                           | ✅ | ❌     | ✅     |
  +-------------------+--------------------------------------+----+--------+--------+
  | 0xFFFA..0x10000   | Experimental                         | ✅ | [1]    | ✅     |
  +-------------------+--------------------------------------+----+--------+--------+
