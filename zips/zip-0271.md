...
The continuation of the 12% lockbox funding stream is ``FS_CCF_H3``, as
defined in ZIP 214 Revision 2 [^zip-0214-funding-streams]. Under the
pre-NU7 block spacing, it spans Mainnet heights 3146400 through 4406399
(1,260,000 blocks) and Testnet heights 3536500 through 4475999
(939,500 blocks). If NU7 activates before the respective end height,
ZIP 214 Revision 3 extends the stream to the revised third-halving
height on that network, calculated using ZIP 218 [^zip-0218].
...
Zcash's 3rd halving under the pre-NU7 block spacing. ZIP 214 Revision 3
[^zip-0214] adjusts the end height to the revised third halving if NU7
activates before the original end height.
