...
If this ZIP activates on the first block after the end of current dev fund as of
this writing and as specified in [^zip-1015-funding-streams], $v$ MUST be:
- 69,300 ZEC on Mainnet, and 
- 78,750 TAZ on Testnet.
...
both Mainnet and Testnet. If this ZIP activates on the first block after the
