...
$\mathsf{12}\%$ of the block subsidy and is extended until block
height $\mathsf{4406400}$.
...
This proposal is to be deployed with the NU6.1 network upgrade. [^#zip-0255]_
...
[^zip-0255]: [ZIP 255: Deployment of the NU6.1 Network Upgrade](zip-0255.rst)
