...
constraint (see [^draft-zodl-valargroup-action-circuit-update]), the activation height
or consensus branch ID (see [^draft-zodl-valargroup-deploy-nu6.3]), or wallet behaviour associated with migration
to Ironwood (see [^draft-zodl-valargroup-ironwood-migration]).
...
[^draft-zodl-valargroup-action-circuit-update]: [NU6.3 Updates to the Orchard-protocol Action Circuit (draft)](draft-zodl-valargroup-action-circuit-update.md)
