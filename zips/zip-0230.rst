...
The encoding of an Orchard note plaintext [#protocol-noteptencoding] is updated and now consists of the following fields:
...
The encodings of $\mathsf{d}$, $\mathsf{v}$, and $\mathsf{rseed}$ remain unchanged from the previous specification in §5.5.3 ‘Encodings of Note Plaintexts and Memo Fields’ of the Zcash Protocol Specification [#protocol-noteptencoding]_.
