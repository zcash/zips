...
+---------------------------------+---------------------------+---------------------------+--------------------------------+------------------------------------+-----------------------------------+
| 8 bit :math:`\mathsf{leadByte}` | 88 bit :math:`\mathsf{d}` | 64 bit :math:`\mathsf{v}` | 256 bit :math:`\mathsf{rseed}` | 256 bit :math:`\mathsf{AssetBase}` | 256 bit :math:`\mathsf{K^{memo}}` |
+---------------------------------+---------------------------+---------------------------+--------------------------------+------------------------------------+-----------------------------------+

* The $\mathsf{leadByte}$ is now encoded to be $\mathsf{0x03}$ for Orchard note plaintexts post the NU7 network upgrade. 
