...
and as Head of Research and Assurance at Zcash Open Development Lab, and
will endeavour to minimize the downsides of that confluence of roles as far
as possible.
...
Sean Bowe declares a potential conflict of interest in acting as a ZIP
Editor while also being a maintainer of Zakura, a Zcash consensus full
node implementation.
...
The Pull-Request header, if present, gives one or more URLs to
Pull Requests for the ZIP.
