...
* ZIP 207 Revision 2: NU7 funding-stream address periods. [^zip-0207]
* ZIP 214 Revision 3: NU7 funding-stream end heights. [^zip-0214]
...
NU7 deploys all of the consensus changes specified in ZIP 218, Revision 2
of ZIP 207, and Revision 3 of ZIP 214. The NSM and transaction-version
changes are specified below. Where those changes conflict
