...
|      | $4$                             | `nVersionGroupId`        | `uint32`                               | Version group ID (nonzero); the version 6 value fixed in [^zip-0258].
|      | $4$                             | `nConsensusBranchId`     | `uint32`                               | Consensus branch ID; MUST be the NU6.3 branch ID [^zip-0258].
...
* `nVersionGroupId` MUST equal the version 6 version group ID, and `nConsensusBranchId`
  MUST equal the NU6.3 consensus branch ID, both defined in [^zip-0258].
...
group ID, and the NU6.3 consensus branch ID are specified in [^zip-0258].
