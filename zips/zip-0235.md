...
An asymmetric fee split favoring the removal mechanism is preferred for the
following reason. [^nsm-incentives]

An equal split, or a split that favors miners, creates a long-term security
