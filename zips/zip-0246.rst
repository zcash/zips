...
A BLAKE2b-256 hash of a subset of OrchardZSA Action Group information for an OrchardZSA Action Group.
The following elements of the Action Group are included in the hash::
