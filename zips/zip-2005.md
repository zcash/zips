...
The term "Orchard[ZSA] protocol" in this document refers to the Orchard
shielded protocol before the deployment of ZSAs, and to the OrchardZSA
shielded protocol after the deployment of ZSAs.
...
*Ironwood-pool* notes as soon as practically possible. This does not depend on support
...
* break Balance for the *Sapling pool* or *Orchard pool* by forging value-commitment
...
* break Spend authentication (i.e. steal funds, independently of a Balance break)
  ...
  spends;
* break Spend authentication for the *Sapling pool* or *Orchard pool* by forging RedJubjub
