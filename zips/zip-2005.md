...
versions of Zcash designed to be so.
...
specification, and to the contents of ZIPs as of June 2026.
...
> Let $\mathsf{pool} \;{\small ⦂}\; \{ \textit{SaplingPool}, \textit{OrchardPool}, \textit{IronwoodPool}\, \}$
...
ability to spend the funds afterward. The window between the activation
height of this ZIP and the switch is the critical exposure period for
recoverable Orchard funds.
...
[^draft-zodl-valargroup-deploy-nu6.3].
