...
.. csv-table::
   ...
   "3..4", "acentry*", "Track internal transfers between accounts in the same wallet", "1. ``string strAccount``
   ...
   "3..4", "**chdseed**", "Encrypted HD seed", "1. ``uint256 seedFp``", "1. ``vector<unsigned char> vchCryptedSecret``"
   ...
   "3..4", "hdseed*", "Hierarchical Deterministic seed. [#zip-0032]_", "1. ``uint256 seedFp``", "1. ``RawHDSeed rawSeed``"
