...
.. csv-table::
   ...
   "3..5", "acc*", "Account data", "1. ``string strAccount``", "1. ``CAccount account``"
   "3..5", "acentry*", "Track internal transfers between accounts in the same wallet", "1. ``string strAccount``
   ...
   "3..5", "**chdseed**", "Encrypted HD seed", "1. ``uint256 seedFp``", "1. ``vector<unsigned char> vchCryptedSecret``"
   ...
   "3..5", "hdseed*", "Hierarchical Deterministic seed. [#zip-0032]_", "1. ``uint256 seedFp``", "1. ``RawHDSeed rawSeed``"
   ...
   "5..6", "networkinfo", "", "", "1. ``string strNetworkInfo``"
   "5..6", "orchard_note_commitment_tree", "", "", "1. ``OrchardWalletNoteCommitmentTreeWriter writer``"
   "5..6", "unifiedaccount", "", "1. ``ZcashdUnifiedAccountMetadata keyMeta``", "1. ``0x00``"
   "5..6", "unifiedfvk", "", "1. ``libzcash::UFVKId ufvkId``", "1. ``libzcash::UnifiedFullViewingKey::Encode(CCHainParams) chainParams``"
   "5..6", "unifiedaddrmeta", "", "1. ``ZcashdUnifiedAddressMetadata addrmeta``", "1. ``0x00``"
   "5..6", "mnemonicphrase", "", "1. ``uint256 seedFp``", "1. ``MnemonicSeed seed``"
   "5..6", "cmnemonicphrase", "", "1. ``uint256 seedFp``", "1. ``vector<unsigned char> vchCryptedSecret``"
   "5..6", "mnemonichdchain", "", "", "1. ``CHDChain chain``"
