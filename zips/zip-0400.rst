...
contain the types that the stored data is representing. The Version column indicates the zcashd version the key is present. 
...
.. csv-table::
   ...
   5. ``CSerializeRecipientAddress recipientAddr``", "1. ``std::string uaString``"
