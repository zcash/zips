...
.. [#zip-0227-specification-global-issuance-state] `ZIP 227: Issuance of Zcash Shielded Assets — Specification: Global Issuance State <zip-0227#specification-global-issuance-state>`_
.. [#zip-0227-assetidentifier] `ZIP 227: Issuance of Zcash Shielded Assets — Specification: Asset Identifier <zip-0227#specification-asset-identifier-asset-digest-and-asset-base>`_
.. [#zip-0227-consensus] `ZIP 227: Issuance of Zcash Shielded Assets — Specification: Consensus Rule Changes <zip-0227#specification-consensus-rule-changes>`_
.. [#zip-0227-note-commitment-order] `ZIP 227: Issuance of Zcash Shielded Assets — Addition to the Note Commitment Tree <zip-0227#addition-to-the-note-commitment-tree>`_
.. [#zip-0227-txiddigest] `ZIP 227: Issuance of Zcash Shielded Assets — TxId Digest - Issuance <zip-0227#txid-digest-issuance>`_
.. [#zip-0227-authcommitment] `ZIP 227: Issuance of Zcash Shielded Assets — Authorizing Data Commitment <zip-0227#authorizing-data-commitment-issuance>`_
.. [#zip-0227-orchardzsa-fee-calculation] `ZIP 227: Issuance of Zcash Shielded Assets — OrchardZSA Fee Calculation <zip-0227#orchardzsa-fee-calculation>`_
...
.. [#protocol-notes] `Zcash Protocol Specification, Version 2025.6.1 [NU6.1]. Section 3.2: Notes <protocol/protocol.pdf#notes>`_
.. [#protocol-actions] `Zcash Protocol Specification, Version 2025.6.1 [NU6.1]. Section 3.7: Action Transfers and their Descriptions <protocol/protocol.pdf#actions>`_
...
.. [#protocol-orcharddummynotes] `Zcash Protocol Specification, Version 2025.6.1 [NU6.1]. Section 4.8.3: Dummy Notes (Orchard) <protocol/protocol.pdf#orcharddummynotes>`_
.. [#protocol-orchardbalance] `Zcash Protocol Specification, Version 2025.6.1 [NU6.1]. Section 4.14: Balance and Binding Signature (Orchard) <protocol/protocol.pdf#orchardbalance>`_
.. [#protocol-rhoandnullifiers] `Zcash Protocol Specification, Version 2025.6.1 [NU6.1]. Section 4.16: Computing ρ values and Nullifiers <protocol/protocol.pdf#rhoandnullifiers>`_
.. [#protocol-actionstatement] `Zcash Protocol Specification, Version 2025.6.1 [NU6.1]. Section 4.18.4: Action Statement (Orchard) <protocol/protocol.pdf#actionstatement>`_
.. [#protocol-endian] `Zcash Protocol Specification, Version 2025.6.1 [NU6.1]. Section 5.1: Integers, Bit Sequences, and Endianness <protocol/protocol.pdf#endian>`_
.. [#protocol-constants] `Zcash Protocol Specification, Version 2025.6.1 [NU6.1]. Section 5.3: Constants <protocol/protocol.pdf#constants>`_
.. [#protocol-concretesinsemillahash] `Zcash Protocol Specification, Version 2025.6.1 [NU6.1]. Section 5.4.1.9: Sinsemilla hash function <protocol/protocol.pdf#concretesinsemillahash>`_
.. [#protocol-concretehomomorphiccommit] `Zcash Protocol Specification, Version 2025.6.1 [NU6.1]. Section 5.4.8.3: Homomorphic Pedersen commitments (Sapling and Orchard) <protocol/protocol.pdf#concretehomomorphiccommit>`_
.. [#protocol-concretesinsemillacommit] `Zcash Protocol Specification, Version 2025.6.1 [NU6.1]. Section 5.4.8.4: Sinsemilla commitments <protocol/protocol.pdf#concretesinsemillacommit>`_
