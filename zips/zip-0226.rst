...
* *All* wallets should be ready to receive funds in outputs of v6 transactions
  as soon as ZSAs activate. The consequence of not doing so would be that funds
  sent to Orchard addresses of a wallet without this support could be
  temporarily inaccessible, until the wallet is upgraded to fully support v6
  and to rescan outputs since v6 activation.
