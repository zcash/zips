...
onward, until the activation of NU6.2 on each network, transactions MUST NOT
contain any Orchard Action descriptions, i.e. $\mathsf{nActionsOrchard} = 0$.

The Mainnet mitigation was deployed as an emergency hotfix in zcashd v6.12.5
and zebra v4.5.3. [^GHSA-zcash-hotfix] [^GHSA-zebra-hotfix] These releases did not have the "until the
activation of NU6.2" restriction; i.e. they disabled Orchard until deployment
