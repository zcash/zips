...
Note that [^draft-ecc-quantum-recoverability] also updates these algorithms, but
...
[^draft-ecc-quantum-recoverability]: [draft-ecc-quantum-recoverability: Quantum Recoverability](draft-ecc-quantum-recoverability.md)
