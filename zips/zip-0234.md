...
[^protocol-notation]: [Zcash Protocol Specification, Version 2025.6.1 [NU6.1]. Section 2: Notation](protocol/protocol.pdf#notation)
...
[^protocol-constants]: [Zcash Protocol Specification, Version 2025.6.1 [NU6.1]. Section 5.3: Constants](protocol/protocol.pdf#constants)

[^protocol-diffadjustment]: [Zcash Protocol Specification, Version 2025.6.1 [NU6.1]. Section 7.7.3 Difficulty Adjustment](protocol/protocol.pdf#diffadjustment)
