...
- Split $I$ into two 32-byte sequences, $I_L$ and $I_R$.
- Use $I_L$ as the child secret key $\mathsf{sk}_{child}$.
- Use $I_R$ as the child chain code $\mathsf{c}_{child}$.
- Return $(\mathsf{sk}_{child}, \mathsf{c}_{child})$.
...
- Let $(\mathsf{sk}, \mathsf{c}) = \mathsf{CKDh}^\mathsf{Registered}((\mathsf{sk}_{par}, \mathsf{c}_{par}), i, \mathsf{tag}, \mathsf{true})$.
