...
label
   ...
   SHOULD preferentially display this label instead of the associated 
   address (the client MUST still make it possible for the user to see the 
   actual address to which the payment will be directed.)
