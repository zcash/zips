...
elements are included in the hash::
   ...
   T.3b.iii.2: enc_ciphertext[564..] (post-memo suffix of field encoding)
...
.. [#protocol-txnencodingandconsensus] `Zcash Protocol Specification, Version 2020.1.20 or later. Section 7.1: Transaction Encoding and Consensus <protocol/nu5.pdf#txnencodingandconsensus>`_
