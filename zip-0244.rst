...
```````````````````````
In the case that transparent inputs or outputs or present, the transparent digest
...
and ZIP 243 [#zip-0243]_. For other input types, the txid may be signed directly.
