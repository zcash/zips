...
A \defining{\note} (denoted $\NoteTuple{}$) can be a \SproutPoolAdj\sapling{ or \SaplingOrOrchardPoolAdj} \note.
In each case it represents that a value $\Value$ is spendable by the recipient who
