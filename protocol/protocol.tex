...
\begin{pnotes}
  \item Assume that $\PRFexpand{}$ is a PRF with output range $\PRFOutputExpand$, and define
        ...
        indistinguishable.
  \item $\reprJOf{\AuthProvePublic}$ will be used as a key for $\PRFnfSapling{}$ (see
...
\begin{itemize}
  ...
  \item Set $\Value = 0$.
  \item Set $\NotePosition = 0$.
  \item Choose uniformly random $\NoteCommitRand \leftarrowR \NoteCommitSaplingTrapdoor$.
  \item Choose uniformly random $\AuthProvePrivate \leftarrowR \GF{\ParamJ{r}}$.
