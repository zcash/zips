...
We define $\KDF \typecolon \setofNew \times \GeneralCRHOutput \times \AsymSharedSecret
\times \AsymPublic \times \AsymPublic \rightarrow \Keyspace$ to be a
\keyDerivationFunction, suitable for use with $\KeyAgreement$ and deriving keys
for $\SymEncrypt{}$.
