...
\newcommand{\coin}{\term{deed}}
\newcommand{\coins}{\term{deeds}}
\newcommand{\Coin}{Deed}
\newcommand{\Coins}{Deeds}
\newcommand{\coinCommitment}{\term{deed commitment}}
\newcommand{\coinCommitments}{\term{deed commitments}}
\newcommand{\CoinCommitment}{\titleterm{Deed Commitment}}
\newcommand{\CoinCommitments}{\titleterm{Deed Commitments}}
\newcommand{\coinCommitmentTree}{\term{deed commitment tree}}
...
\newcommand{\spentSerialsMap}{\term{nullifier map}}
\newcommand{\SpentSerials}{\titleterm{Nullifiers}}
\newcommand{\SpentSerialsMap}{\titleterm{Nullifier Map}}
...
\newcommand{\coinPlaintext}{\term{deed plaintext}}
\newcommand{\coinPlaintexts}{\term{deed plaintexts}}
\newcommand{\CoinPlaintexts}{\titleterm{Deed Plaintexts}}
\newcommand{\coinsCiphertext}{\term{transmitted deeds ciphertext}}
...
\newcommand{\sn}{\mathsf{dn}}
\newcommand{\snOld}[1]{\mathsf{{dn}^{old}_\mathnormal{#1}}}
...
\newcommand{\cOld}[1]{\mathbf{d}_{#1}^\mathsf{old}}
\newcommand{\cNew}[1]{\mathbf{d}_{#1}^\mathsf{new}}
\newcommand{\cpNew}[1]{\mathbf{dp}_{#1}^\mathsf{new}}
...
\newcommand{\Commitment}{\mathtt{DeedCommitment}}
...
value in a single transaction, e.g. to spend a protected coin that
has just been created. (In \Zcash, we refer to value stored in UTXOs
as ``transparent'', and value stored in Pour output coins as ``protected''.)
