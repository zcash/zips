...
range $\binaryrange{31}$, and \SHOULD support \blockHeights in the range $\binaryrange{63}$.
\footnote{\zcashd currently only supports \blockHeights in the range $\binaryrange{31}$.}
...
\vspace{-0.25ex}
Let $\ExtractPbot \typecolon \GroupP \rightarrow \MerkleHashOrchard$ be as
