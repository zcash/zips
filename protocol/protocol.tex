...
and a destination \Orchard \paymentAddress $(\Diversifier, \DiversifiedTransmitPublic)$,
...
The S-box function is $x \mapsto x^5$. The number of outer rounds $R_P$ is $58$,
and the number of inner rounds $R_F$ is $8$.
...
\hbadness=10000
\begin{tabularx}{1.4\textwidth}{|c|c|l|p{11.1em}|L|}
\hline
...
\vspace{-0.3ex}
\scalebox{0.85}{
\begin{tabularx}{1.17\textwidth}{@{\!\!}l@{\hskip 1em}X@{}}
$\footnotestar$ & It is not yet decided whether these fields will be included. \\[-0.5ex]

$\dagger$ & The fields \joinSplitPubKey{} and \joinSplitSig{} are present if and only if
$\nJoinSplit > 0$. \\[-0.5ex]
