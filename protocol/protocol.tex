...
\nufive{
    ...
    \item Change the note in \crossref{addressesandkeys} to say that ``most \Zcash wallets'', not
          just \zcashd, derive \SaplingAndOrchard keys and addresses according to \cite{ZIP-32}.
} %nufive
\sapling{
