...
and represent the byte sequence $[\hexint{D2}, \hexint{BC}, \hexint{A3}, \hexint{12}]$.
...
in this position are used to distinguish uses of the full $\SHAOrig$ hash function ---
...
\begin{lrbox}{\kdfbox}
\setchanged
\begin{bytefield}[bitwidth=0.038em]{840}
    \bitbox{24}{0} &
    \bitbox{24}{1} &
    \bitbox{24}{1} &
    \bitbox{24}{1} &
    \bitbox{112}{4 bit $\KDFLeadNibble$} &
...
\hskip 1.5em $\FullHashbox{\kdfbox}$.
\vskip 1.2ex}
}
