...
\introlist
A \spendDescription consists of $(\rt, \cv, \nf, \ProofSpend, \spendAuthSig)$
...
\begin{consensusrules}
  ...
  \item The proof $\Proof{\Spend}$ \MUST be valid given a \primaryInput formed
        ...
        I.e.\ it must be the case that $\SpendVerify{}((\rt, \cv, \nf), \Proof{\Spend}) = 1$.
...
It is based on the work of Jurjen Bos, David Chaum, George Purdy,
Eugène van Heijst and Birgit Pfitzmann in \cite{BCP1988} and \cite{CvHP1991},
...
\todo{It is instantiated as EdJubjub...}
}
...
timestamp at or after 2018-03-01 00:00:00 UTC. \todo{this will probably change
to use the MPC randomness beacon.}
