...
\newcommand{\NUSixThreeActivationHeight}{\mathsf{NU6\_3ActivationHeight}}
...
go to the \IronwoodPool after that point \cite{ZIP-318}.}
...
\nufive{
  \item $\NUSixThreeActivationHeight \typecolon \Nat := \begin{cases}
          TODO,&\squash\text{for \Mainnet} \\
          TODO,&\squash\text{for \Testnet}
        \end{cases}$
} %nufive
