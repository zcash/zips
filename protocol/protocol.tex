...
The resulting \defining{\noteCiphertext} is $(\ephemeralKey, \TransmitCiphertext{}, \OutCiphertext)$.
...
\begin{pnotes}
  ...
  \item Normally only \noteCiphertexts of \transactions in \blocks need to be decrypted. In that case,
        ...
        $\nf = \PRFnfSapling{\AuthProvePublicRepr}\big(\reprJ(\NoteAddressRand)\kern-0.15em\big)$ is
...
\begin{pnotes}
  ...
  \item The comments in \crossref{saplingdecryptivk} concerning calculation of $\NoteAddressRand$, detection
        of spent \notes, and decryption of \noteCiphertexts for \transactions in the \mempool also apply to
...
Ying Tong Lai, Kris Nuttycombe, and Jack Gavigan.
...
\historyentry{2020.1.16}{2020-01-10}
\begin{itemize}
