...
$\mathtt{010x}$}\vk{, and $\mathtt{011x}$} are included (respectively) within the blocks
...
\vNew{i}, \CoinAddressRandNew{i}, \CoinCommitRandNew{i}, \Memo_i)$\vk{,
...
\setvk
\begin{bytefield}[bitwidth=0.052em]{512}
...
\subsection{\vk{Decryption by a Viewing Key Holder}}
...
\vk{\viewingKeys,\;} \coinPlaintexts, and \PourDescriptions.
...
The raw encoding of a \coinPlaintext $(\changed{\AuthPublic,\;}\Value, \CoinAddressRand,
\CoinCommitRand\changed{, \Memo})$ consists of, in order:
