...
\sapling{
\introsection
\phantomsection\label{bindingsig}
\lsubsection{Balance and Binding Signature (\SaplingText)}{saplingbalance}
...
\phantomsection\label{boxnotation}
...
\phantomsection\label{concretejssig}
\lsubsubsection{\EdSpecificText}{concreteed25519}
...
\sapling{
\phantomsection\label{concreteredjubjub}
\lsubsubsection{\RedDSAText{} and \RedJubjubText{}}{concretereddsa}
...
\sapling{
\introsection
\phantomsection\label{concretesaplingnotecommit}
\lsubsubsubsection{Windowed Pedersen commitments}{concretewindowedcommit}
...
\sapling{
\phantomsection\label{concretevaluecommit}
\lsubsubsubsection{Homomorphic Pedersen commitments}{concretehomomorphiccommit}
...
\phantomsection\label{reddsabatchverify}
\lsubsection{\RedDSAText{} batch validation}{reddsabatchvalidate}
