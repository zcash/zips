...
The funds SHALL be received and administered by the Zcash Foundation (ZF) or
Financial Privacy Foundation (FPF). ZF or FPF MUST disburse them for grants and
...
4. The ZCG committee SHOULD be restricted to funding projects that further the
   ...
   furthering financial privacy in general) as permitted under Section
   501(c)(3) or, in the case of FPF, similar requirements of the relevant
   jurisdiction.
...
6. The ZCG Committee’s funding decisions will be final, requiring no approval
   from the ZF Board, but are subject to veto if the Foundation judges them to
   violate U.S. law or the ZF’s reporting requirements and other (current or
   future) obligations under U.S. IRS 501(c)(3) or, in the case of FPF, other
...
7. ZCG Committee members SHALL have a one-year term and MAY sit for reelection.
   ...
   person with association with the BP/ECC, and at most one person with
   association with the ZF, are allowed to sit on the ZCG Committee.
...
9. A portion of the Discretionary Budget MAY be allocated to provide reasonable
   ...
   administered by the ZF or FPF. The compensation rate and hours for committee
...
10. The ZCG Committee’s decisions relating to the allocation and disbursement
    ...
    from the ZF or FPF Board, but are subject to veto if the Foundation judges
    them to violate U.S. law or the ZF’s reporting requirements and other
    (current or future) obligations under U.S. IRS 501(c)(3), or, in the case
    of FPF, other similar requirements of the relevant jurisdiction.

ZF or FPF SHALL recognize the ZCG slice of the Dev Fund as a Restricted Fund
donation under the above constraints (suitably formalized), and keep separate
accounting of its balance and usage under its Transparency and Accountability
obligations defined below.

ZF or FPF SHALL strive to define target metrics and key performance indicators,
...
accepted and disbursed by ZF or FPF, but rather directly assigned to the
