...
target spacing and issuance-per-block rates, while maintaining an unchanged
target-time-based issuance schedule. Such a target-time / issuance rate change
occurred at the Blossom network upgrade, for example. [#zip-0208]_
